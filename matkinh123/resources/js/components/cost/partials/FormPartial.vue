    ...
    <div class="col-md-12">
      ...
      <div class="form-row">
        <div class="form-group col-md-3">
          <label for="type">Tên loại chi phí</label>
        ...
        <div class="form-group col-md-6">
          <label for="name">Tên chi phí</label>
          <div class="input-group mb-3">
            ...
            <input v-model="form.name" type="text" class="form-control" placeholder="* Điền tên loại chi phí" tabindex="3">
        ...
        <div class="form-group col-md-4">
          <label for="monthlyfee">Kết chuyển chi phí hàng tháng</label>
          <div class="input-group mb-2">
            <div class="input-group-prepend">
              <label class="input-group-text" for="monthlyfee"><span data-feather="dollar-sign"></span></label>
            </div>
            <select v-model="form.monthlyfee" class="form-control" id="monthlyfee" tabindex="7">
              <option v-for="(monthlyfee, index) in lstMonthlyfee" :key="index" :value="index">{{ monthlyfee }}</option>
            </select>
          </div>
        </div>
        <div class="form-group col-md-4">
...
export default {
  ...
  methods: {
    onSubmit(evt) {
      ...
      // Thêm sản phẩm
      axios.post('/api/costs', {data: this.form, _method: 'PUT'})
        .then(res => {
    ...
    editRow(evt) {
      ...
      axios.post('/api/costs/' + this.form.c_id, {data: this.form, _method: 'PUT'})
        .then(res => {
          if (res.data.status === 200) {
